...
# Рекомендуется 'False' в продакшене,
# но 'True' удобно для разработки и тестов
...
INSTALLED_APPS = [
    ...
    # (должен быть перед staticfiles, если используется runserver_nostatic)
...
TEMPLATES = [
    {
        ...
        # Разрешаем Django искать шаблоны внутри папок приложений (templates/)
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
