...
class UserDeleteView(LoginRequiredMixin, UserPassesTestMixin, SuccessMessageMixin, DeleteView):
    ...
    #     messages.success(self.request, self.success_message) # Добавляем сообщение вручную, т.к. SuccessMessageMixin может не сработать при переопределении post/delete
    #     return super().delete(request, *args, **kwargs) # Используем delete, а не post
